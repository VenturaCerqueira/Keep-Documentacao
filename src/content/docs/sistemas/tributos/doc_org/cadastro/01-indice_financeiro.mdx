...
## 🖱️ Funcionalidades na Interface:
   <Steps>
      1. **🔍 Pesquisar**: Acesso a listagem de índices financeiros cadastrados no sistema.
         
      2. **👁️‍🗨️ Ações/visualizar**: Acesso ao formulário para cadastro de novos índices financeiros.
